...
# alunos = json.load(open('./data/alunos_ativos.json'))
...
def normalizaDados(dado):
    ...
    df.drop(
        [
            ...
            'possui_matricula_em_disciplina_20182', 'data_expedicao_identidade', 
            'municipio_naturalidade', 'uf_naturalidade', 'conclusao_ensino_medio',
            'escola_ensino_medio', 'cidade_ensino_medio', 'uf_ensino_medio',
            'cidade_endereco', 'uf_endereco', 'total_trancamentos',
            'possui_tracamento_compulsorio', 'percentual_integralizado.1',
